...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th10 16, 2019 lúc 04:23 AM
...
(45, 'dmhoang', 'acfbeb1a4c1862482f11724402319db9', 'student'),
...
(34, 'sjfl', '81dc9bdb52d04dc20036dbd8313ed055', 'student'),
...
(44, 'tvduy', '0535be826cf1c14d160ef623a153ad52', 'student'),
...
(22, 'Ky nang mem', '2015-01-01', '2016-01-01', 0, '2019-10-16 01:17:45');
...
(14, 'Quản lý dự án', '4 năm', '2019-10-16', '5000000', 'manager');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `program_student`
--
...
--
-- Đang đổ dữ liệu cho bảng `program_student`
--
...
(37, 4, 23, 'Đăng ký', b'1', b'0', b'0', NULL, '2019-09-18 01:43:29'),
(38, 8, 23, 'Tạm hoãn', b'1', b'1', b'0', NULL, '2019-09-18 01:46:41'),
(39, 3, 23, 'Tạm hoãn', b'1', b'1', b'1', 7.43, '2019-09-18 01:47:35'),
...
(43, 1, 26, 'Đăng ký', b'1', b'0', b'0', NULL, '2019-09-27 08:41:13'),
(45, 12, 28, 'Đăng ký', b'1', b'0', b'0', NULL, '2019-09-27 08:46:31'),
(46, 3, 28, 'Tạm hoãn', b'1', b'1', b'0', NULL, '2019-09-27 08:49:16'),
(47, 4, 28, 'Tạm hoãn', b'1', b'1', b'0', NULL, '2019-09-27 08:50:45'),
(48, 5, 28, 'Tạm hoãn', b'1', b'1', b'0', NULL, '2019-09-27 08:52:04'),
...
(54, 12, 30, 'Tạm hoãn', b'1', b'1', b'1', 6.13, '2019-10-02 01:49:50'),
(55, 7, 30, 'Có ý thích', b'0', b'1', b'0', NULL, '2019-10-02 02:23:22'),
(56, 8, 31, 'Có ý thích', b'0', b'0', b'0', NULL, '2019-10-02 02:28:25'),
(57, 13, 32, 'Đăng ký', b'0', b'0', b'0', NULL, '2019-10-02 02:31:12'),
(58, 9, 33, 'Đăng ký', b'1', b'0', b'1', 7, '2019-10-02 03:02:34'),
(59, 3, 33, 'Có ý thích', b'0', b'1', b'0', NULL, '2019-10-02 03:04:16'),
(60, 14, 34, 'Tạm hoãn', b'1', b'0', b'0', NULL, '2019-10-16 08:48:17'),
(61, 13, 34, 'Đăng ký', b'1', b'1', b'0', NULL, '2019-10-16 08:49:54');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `program_subject`
--
...
--
-- Đang đổ dữ liệu cho bảng `program_subject`
--
...
(34, 'Đỗ Minh Hoàng', '1999-01-01', 'example@mail.com', 'An Giang', 'dmhoang', '2019-10-16 01:48:17');
...
--
-- Cấu trúc đóng vai cho view `v_registars_list`
...
--
-- Cấu trúc cho view `v_registars_list`
--
...
--
-- Chỉ mục cho bảng `program_student`
--
ALTER TABLE `program_student`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `program_subject`
--
...
--
-- AUTO_INCREMENT cho bảng `program_student`
--
ALTER TABLE `program_student`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT cho bảng `program_subject`
--
ALTER TABLE `program_subject`
